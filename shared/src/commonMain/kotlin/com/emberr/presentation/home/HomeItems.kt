...
sealed interface HomeItem {
    ...
    data class Folder(val folder: FolderEntity, override val level: Int = 0) : HomeItem {
        override val key: String get() = com.emberr.presentation.home.HomeItemKey.forFolder(folder.folderId)
    }

    data class Note(val note: NoteMetadataEntity, override val level: Int = 0) : HomeItem {
        override val key: String get() = com.emberr.presentation.home.HomeItemKey.forNote(note.noteId)
    }
}

private val com.emberr.presentation.home.HomeItem.typeRank: Int
    get() = when (this) {
